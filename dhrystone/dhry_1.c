...
/* Dhrystone port, corelink, 2019-09-02 */

#include "proton.h"

#define HZ 					(1000)
#define Too_Small_Time 		(10*HZ)
  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  else
  {
    ...
    printf ("Dhrystones MIPS/MHz:                        ");
    //printf ("%6.1f \n", Dhrystones_Per_Second / 1757.0);
    printf ("%d / 1757.0 / 32.0 \n", (int)Dhrystones_Per_Second);
